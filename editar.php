<?php session_start(); include('editar_handler.php')?>
...
<div class="formDiv">
  <form id="form1" enctype="multipart/form-data" class="registro" action="<?php echo $_SERVER['PHP_SELF'];?>"method="post">
    ...
    <div class="column">
      ...
      <p style="position:relative; z-index: 3;" class="check_radio">En que departamento y municipio esta ubicada tu finca?</p>
  <div class="elevator">
...
<div class="imgContainer">
      <div class="img1">
        <img id="img1" class="error-fixed" src="<?php echo $fileData[0]; ?>" alt="finca">
      </div>
<div class="secun">
      <div class="imgSecun">
        <img id="img2" class="error-fixed" src="<?php echo $fileData[1]; ?>" alt="finca">
      </div>
      <div class="imgSecun">
        <img id="img3" class="error-fixed" src="<?php echo $fileData[2]; ?>" alt="finca">
      </div>
      <div class="imgSecun">
        <img id="img4" class="error-fixed" src="<?php echo $fileData[3]; ?>" alt="finca">
      </div>
      <div class="imgSecun">
        <img id="img5" class="error-fixed" src="<?php echo $fileData[4]; ?>" alt="finca">
      </div>
      <div class="imgSecun">
        <img id="img6" class="error-fixed" src="<?php echo $fileData[5]; ?>" alt="finca">
      </div>
      <div class="imgSecun">
        <img id="img7" class="error-fixed" src="<?php echo $fileData[6]; ?>" alt="finca">
      </div>
    </div>
</div>
...
<div class="column">
  ...
  <div class="center_submit">
    <input type="submit" value="Guardar cambios" name="submit" form="form1">
